  ...
  return (
    <div className="pixarts-logo">
      ...
      >
        <defs>
          {/* Gradient per la X */}
          <linearGradient id="x-gradient-admin" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        <path d="M75 10 L110 70" stroke="url(#x-gradient-admin)" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
        <path d="M110 10 L75 70" stroke="url(#x-gradient-admin)" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
